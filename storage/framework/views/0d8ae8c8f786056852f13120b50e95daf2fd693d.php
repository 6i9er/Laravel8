        ...
        <form class="my-4"  wire:submit.prevent="submit">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="text" class="p-2 rounded border shadow-sm w-full" placeholder="Email"
...
<?php /**PATH /var/www/html/blog/resources/views/livewire/login.blade.php ENDPATH**/ ?>